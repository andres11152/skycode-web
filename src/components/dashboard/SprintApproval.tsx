  ...
  if (sprint.approval_status) {
    return (
      ...
      >
        ...
        {sprint.approval_comment && <p className="mt-1 text-background/60">{sprint.approval_comment}</p>}
      </div>
    );
  }
    ...
    return (
      <div className="space-y-2">
        ...
        <textarea
          ...
          rows={2}
          className="w-full rounded-lg border border-background/15 bg-background/10 px-2.5 py-1.5 text-[11px] text-background placeholder:text-background/40 outline-none focus:border-accent resize-none"
        />
        <div className="flex gap-2">
          <button
            onClick={() => submit(showComment)}
            disabled={isSubmitting}
            className={`flex-1 flex items-center justify-center gap-1 rounded-lg px-2.5 py-1.5 text-[11px] font-bold text-white disabled:opacity-50 outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-foreground ${
          ...
          <button
            ...
            className="rounded-lg border border-background/15 px-2.5 py-1.5 text-[11px] text-background/70 hover:bg-background/10 outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-foreground"
          >
            Cancelar
          </button>
        </div>
  ...
  return (
    <div className="flex gap-2">
      <button
        ...
        className="flex-1 flex items-center justify-center gap-1 rounded-lg border border-green-500/30 bg-green-500/10 px-2.5 py-1.5 text-[11px] font-bold text-green-400 hover:bg-green-500/20 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-foreground"
      >
